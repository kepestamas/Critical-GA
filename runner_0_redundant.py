...
def main():
    ...
    with open(csv_file, 'w', newline='') as csvfile:
            ...
            param_names = ['budget', 'population_size', 'tournament_size', 'p_crossover', 'p_mutation', 'payoff_function']
            ...
            for combo in itertools.product(*param_values):
                budget, pop_size, tournament_size, p_cross, p_mut, payoff = combo

                combo_desc = f"budget={budget}, pop={pop_size}, tour={tournament_size}, cross={p_cross}, mut={p_mut}, payoff={payoff}"
